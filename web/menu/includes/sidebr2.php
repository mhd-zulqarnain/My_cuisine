...
<div id="London" class="tabcontent" style="margin-top: 0px; color: black;">
 ...
 while ($row=mysqli_fetch_array($run)) {
                         ...
                         ?>
                      <div class="well well-lg" style="margin-left: 3px;height: 180px;width: 900px">
   ...
   <div class="container" style="width:1000px;padding-top: 10px;margin-left: 5px;" >
                     <div class="panel panel-default" >
                       <div class="panel-heading"><h3><b>Diet Menu</b></h3></div>
                        <div class="container" style="width:750px;margin-top: 10px;margin-left:15px" >
...
<form  method="POST" action="">
            ...
            <div class="question question1" style="background-color: lightblue;">
                <p>Select available no of calories</p>
                <select name="calories" id="main" required="">
                    <?php echo $options;?>
             ...
             <div class="question question1" style="background-color: lightblue;">
                <p>Select available no of Fats</p>
                <select name="fats" id="main" required="">
                    <?php echo $options1;?>
             ...
             <div class="question question1" style="background-color: lightblue;">
                <p>Select available no of Carbohydrates</p>
                <select name="carb" id="main" required="">
                    <?php echo $options2;?>
              ...
              <div class="question question1" style="background-color: lightblue;">
                <p>Select available no of Proteins</p>
                <select name="proteins" id="main" required="">
                    <?php echo $options3;?>

                </select>
                
            </div>
            <div class="question question2" style="background-color: lightblue;">
                
                 
                 <p><a href="#formm" data-toggle="modal" data-dismiss="modal" style="float: right;">Visit our Calorie Chart(For Womens)</a></p>
                 <p><a href="#formw" data-toggle="modal" data-dismiss="modal" style="float: right;">Visit our Calorie Chart(For Mens)</a></p>
                 <p><a href="#formf" data-toggle="modal" data-dismiss="modal" style="float: right;">How many fats do you required?</a></p>
                  <p><a href="#formcarb" data-toggle="modal" data-dismiss="modal" style="float: right;">How many carbs do you required?</a></p>
                 <p><a href="#formpro" data-toggle="modal" data-dismiss="modal" style="float: right;">How many Proteins do you required?</a></p>
            </div>
...
document.getElementById("defaultOpen").click();
 ...
 <script  src="js3/indexdietmenu.js"></script>
</body>
</html>
