...
<body>
<div class="modal fade" id="formc">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title"><b>CHART</b></h3>
      </div>
...
<table>
    <thead>
        <tr>
            <th>Gender</th>
            <th>Calories Required (kcal)</th>
            <th>Fats Required (kg)</th>
            <th>Carb Required (kg)</th>
            <th>Protein Required (kg)</th>
        </tr>
    </thead>
    <tbody>
        <tr>
