...
<body>
<div class="modal fade" id="formpro">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title"><b>Recommended Carbohydrate</b></h3>
      </div>
...
<table>
    <thead>
        <tr>
            <th>Age</th>
            <th>Grams of protein needed each day</th>
    ...
    <tbody>
       <tr>
            <td>Children ages 9-13</td>
            <td>34</td>
            
            
        </tr>
         <tr>
           <td>Girls ages 14-18</td>
            <td>46</td>
        </tr>
        
        <tr>
            <td>Boys ages 14-18</td>
            <td>52</td>
        </tr>
        <tr>
           <td>Women ages 19-70+</td>
            <td>46</td>
        </tr>
         <tr>
           <td>Men ages 19-70+</td>
            <td>56</td>
        </tr>
