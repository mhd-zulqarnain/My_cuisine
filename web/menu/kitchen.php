        ...
        <div class="container" style="width: 1150px;">
            <div class="load_more">
                <h3 class="w3layouts-title"
                    style="font-size: 50px;color: #a51c21;text-transform: capitalize;margin-left:20px;padding: 0;font-family: 'Rancho', cursive;">
                    <img src="images/menu1.png" class="img-responsive" alt=""/>Featured Kitchens</h3>
                <ul id="myList">
                    <li>
                        <div class="l_g">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Fusce et congue nibh, ut ullamcorper magna. Donec ac massa tincidunt, fringilla sapien vel,
                            tempus massa. Vestibulum
                            felis leo, tincidunt sit amet tristique accumsan. In vitae dapibus metus. Donec nec massa
                            non nulla mattis aliquam
                            egestas et mi.</p>
                    </div>
                </div>
            </div>
