			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Reservation Requests</h2>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->no_of_guest);?></td>
											<td><?php echo htmlentities($result->time_from);?></td>
											<td><?php echo htmlentities($result->time_to);?></td>
...
{
	?><a href="manage-request.php?aeemail=<?php echo htmlentities($result->fl_email);?>" onclick="return confirm('Do you really want to Approved this order')"> Disapproved</a>
<?php } else {?>

<a href="manage-request.php?eemail=<?php echo htmlentities($result->fl_email);?>" onclick="return confirm('Do you really want to Disapproved this order')"> Approved</a>
</td>
<?php } ?></td>
