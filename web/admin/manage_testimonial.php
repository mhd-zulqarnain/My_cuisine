...
<!--heder end here-->
	<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for testimonil.." title="type a testimonial"/>
		<!--grid-->
...
<table class="table table-striped table-hover table-bordered" id="myTable" align="center">
