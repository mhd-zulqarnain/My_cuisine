...
if($run){
echo "Testimonial Successfully InActive";
}
}
...
<tbody>
	<?php 
	   ...
	   ?>
	    	...
	    	<td><?php echo $msg;?></td>
	    	<td><?php echo $date;?></td>
	    	<!--<td><a href='manage_testimonial.php?a_id=$user_id'>InActive</a></td>-->
	    	<td><?php if($status=="" || $status==0)
{
	?>      <a href='manage_testimonial.php?a_id=$user_id'> Inactive</a>
<?php } else {?>
