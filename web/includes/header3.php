				...
				<nav class="navbar navbar-default">
					...
					<div class=" nav collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="../home.php" class="hvr-underline-from-center scroll">About</a></li>
							<li><a href="../home.php" class="hvr-underline-from-center scroll">Menu</a></li>
						...
						<!--<li><a href="#gallery" class="hvr-underline-from-center scroll">Gallery</a></li> -->
							<li><a href="../home.php" class="hvr-underline-from-center scroll">Contact Us</a></li>
                        ...
                        <!--    <drop down -->
                          ...
                          <?php }?>
                                  ...
                                  <div id="myDropdown" class="dropdown-content">
                                   ...
                                   <li><a href="profile.php">Update Password</a></li>
