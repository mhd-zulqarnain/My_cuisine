...
<div class="w3-container">
  <div id="id01" class="w3-modal" >
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:2000px;border-radius:10px;">
      ...
      <div class="w3-center"><br>
        ...
        <div style="border: 1px solid black;margin-left:10px;margin-right:10px;border-radius:10px">
        <center><b><p style="font-size:38px">JOIN US  IN 3 SIMPLE STEPS</p></b></center><br>
        <center><p style="font-size:20px"><b>1- fill the form </b>&nbsp;<b>2- whatsapp your kitchen picture</b> &nbsp;<b>3-get your food tested</b></p></center>
      </div>
