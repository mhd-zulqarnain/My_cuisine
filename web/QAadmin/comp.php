  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><b>Complain</b></h3>
      </div>
          ...
          <div class="login_wrap">
            <div class="col-md-12 col-sm-6">
              <form method="post" action="">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="k_name" placeholder="Kitchen Name*">
                </div>
                <input type="textarea" class="form-control" name="message" placeholder="Type your message*" style="background:#gery;">
                </div>
